...
const apiKey = "?api_key=" + "61c895fec89cd80c637bc4078e876a30";
...
module.exports.getCastAndCrew = async function (movieId){
    ...
    for(i in castList){
        var castObject = {
            ...
            profile_path : "https://image.tmdb.org/t/p/w500/" + castList[i].profile_path
        }; 
    ...
    for(i in crewList){
        if(crewList[i].job == "Producer" || crewList[i].job == "Director"){
            var crewObject = {
                ...
                job: crewList[i].job,
                profile_path: "https://image.tmdb.org/t/p/w500/" + crewList[i].profile_path
            };
...
module.exports.getSimilarMovie = async function (movieId){
    ...
    for(i in similarMovieList){
        var similarMovieObj = {
            ...
            poster_path : "https://image.tmdb.org/t/p/w500/" + similarMovieList[i].poster_path,
